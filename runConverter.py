...
def main():
    ...
    parser.add_argument('--s', metavar='source', dest="src_enc", choices=["utf","wx"], required=True, help="%s" %src_enc_help)
    parser.add_argument('--t', metavar='target', dest="trg_enc", choices=["utf","wx"], required=True, help="%s" %trg_enc_help)
